...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		hue: 175.716, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	navbarTitle: {
		// 顶栏标题文本
		text: "kitsuneX07's blog",
		// 顶栏标题图标路径，默认使用 public/assets/home/home.png
		icon: "assets/home/home.png",
	},

	bangumi: {
		userId: "1188484", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/KitsuneX07",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/403335715",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/ena.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "KitsuneX07",
	bio: "Tell him to find me an acre of land",
	typewriter: {
